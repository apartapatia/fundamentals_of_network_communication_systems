...
class BinaryVector:
    ...
    def random_indices(self, num_indices):
        ...
        :param num_indices: Количество случайных индексов, которые нужно сгенерировать.

        :return: Список случайных индексов.
        """
    ...
    def error_random_coefficient(self, num_errors):
        ...
        :param: num_errors (int): Количество коэффициентов, которые нужно инвертировать.
        """
